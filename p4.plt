...
set output 'figures/perf/scaling_davidson.pdf'
unset clip points
set clip one
unset clip two
...
plot x title "Ideal", 'data_davidson' index 2 u 1:(11996.536/$2) title '42 959 496 dets' w lp, 'data_davidson' index 1 u 1:(836.1914/$2) title '9 356 952 dets' w lp
#    EOF
