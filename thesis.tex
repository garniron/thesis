...
Avant tout, je remercie bien entendu mon directeur de thèse Anthony, son flot ininterrompu d'idées toutes intéressantes mais trop nombreuses pour espérer en exécuter une fraction, son humour toujours fin et sa bienveillance naturelle. Je remercie également Michel, Jean-Paul et Titou, véritables puits de science, pour les moult discussions enrichissantes.
...
Je laisse le mot de la fin à ma petit Aurore venue m'apporter son soutien au beau milieu de ma thèse:
...
The \QP developed at the LCPQ is a suite of wave function quantum
