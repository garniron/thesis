...
\begin{algorithm}
        ...
        \label{alg:selection}
        \tcc{For simplification purpose, a determinants $\ket S$ is here represented by a single bitstring $S_\sigma$ where each bit is associated with a spinorbital}
