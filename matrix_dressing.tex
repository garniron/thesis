...
This idea is based on the so-called Bk approximation proposed by Gershgorn and Shavitt\cite{Gershgorn_1968}. 
...
\item
computing an extra ${\pmb \kappa}_k$ comes with minimal cost
\end{itemize}
...
But the proposed algorithm does not put any restriction. This same approach could be used to compute an exponential dressing. 
