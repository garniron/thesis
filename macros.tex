...
\newcommand{\Nalpha}{{N_\text{elec}^{\uparrow}}}
\newcommand{\Nbeta}{{N_\text{elec}^{\downarrow}}}
\newcommand{\Nint}{{N_\text{int}}}
\newcommand{\Nproc}{{N_\text{proc}}}
\newcommand{\Ndav}{{N_\text{dav}}}
\newcommand{\Ncp}{{N_\text{cp}}}
\newcommand{\Nperm}{{N_\text{perm}}}
\newcommand{\Nteeth}{N_\text{teeth}}
\newcommand{\Na}{{$\left( Na$}}
\newcommand{\Nb}{{$\left( Nb$}}
\newcommand{\Ne}{{$\left( Ne$}}
\newcommand{\NFCI}{N_\text{FCI}}
\newcommand{\Nalphadet}{{N_\text{det}^{\uparrow}}}
\newcommand{\Nbetadet}{{N_\text{det}^{\downarrow}}}

%bitmasks
\newcommand{\bit}[1]{{{#1}}}
\newcommand{\bitP}{{\bit{P}}}
\newcommand{\bitI}{{\bit{I}}}
\newcommand{\bitJ}{{\bit{J}}}
\newcommand{\bitK}{{\bit{K}}}
\newcommand{\bitx}[2]{{{#1}_{#2}}}
...
\newcommand{\kI}{{\ket{D_I}}}
\newcommand{\kIp}{{\ket{D_I'}}}
\newcommand{\kJ}{{\ket{D_J}}}
\newcommand{\kJp}{{\ket{D_J'}}}
\newcommand{\kK}{{\ket{D_K}}}
...
\newcommand{\iproc}{{i_\text{proc}}}

%centering in tables
\newcommand{\tabc}[1]{\multicolumn{1}{c}{#1}}

\newcommand{\deltabold}{\pmb \delta}
\newcommand{\Deltabold}{{\bf \Delta}}
