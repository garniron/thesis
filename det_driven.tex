...
\alert{j'ai retiré le $\ordering$ de equation \ref{eq:ordering_removed} pour coherence avec la partie MRCC, ca n'a pas l'air de poser de probleme}\\
...
\begin{equation}
 max(p,r) > min(q,s) \wedge max(q,s) > min(p,r)
\end{equation}
